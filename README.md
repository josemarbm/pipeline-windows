[![CI-CD-HelloWorld](https://github.com/josemarbm/pipeline-windows/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/josemarbm/pipeline-windows/actions/workflows/ci-cd.yml)
